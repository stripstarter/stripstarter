...
[StripStarter](http://stripstarter.us) is a crowdfunding pornography app.  The idea is that two types of people can make campaigns:
...
An example would be a crowd-sourced campaign for Barack Obama to take a series of photographs in a state of undress.  In our business plan, this campaign would exist and be publicly funded by a number of pledgers, raising the number high enough for the President to decide he wants to release such material through our distribution platform to those pledgers.
