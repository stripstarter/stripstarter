...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "chef_solo" do |chef|
    chef.cookbooks_path = ["~/Sites/stripstarter/cookbooks", "~/Sites/chef-repo/cookbooks"]
    # chef.roles_path = "~/Sites/chef-repo/roles"
    # chef.data_bags_path = "~/Sites/chef-repo/data_bags"
    # chef.add_recipe "stripstarter::default"
    # chef.add_role "web"
